...
{
    /// <inheritdoc />
    public partial class InitialSaleSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shipping_full_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    shipping_phone_number = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sale_sales", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sale_items_sale_sales_sale_id",
                        column: x => x.sale_id,
                        principalTable: "sale_sales",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sale_status_history_sale_sales_sale_id",
                        column: x => x.sale_id,
                        principalTable: "sale_sales",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sale_sales_sale_number",
                table: "sale_sales",
                column: "sale_number",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_sale_status_history_sale_id",
