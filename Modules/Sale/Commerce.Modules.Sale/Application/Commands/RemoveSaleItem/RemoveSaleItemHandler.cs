...
public sealed class RemoveSaleItemHandler : IRequestHandler<RemoveSaleItemCommand, ApiResponse<SaleDto>>
{
    ...
    public async Task<ApiResponse<SaleDto>> Handle(RemoveSaleItemCommand command, CancellationToken cancellationToken)
    {
        ...
        _dbContext.SaleItems.Remove(item);
