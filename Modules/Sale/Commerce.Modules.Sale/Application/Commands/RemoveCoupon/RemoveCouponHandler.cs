...
public sealed class RemoveCouponHandler : IRequestHandler<RemoveCouponCommand, ApiResponse<SaleDto>>
{
    private readonly SaleDbContext _dbContext;
    private readonly ISalePricingService _salePricingService;
    private readonly IMapper _mapper;

    public RemoveCouponHandler(
    ...
    public async Task<ApiResponse<SaleDto>> Handle(RemoveCouponCommand command, CancellationToken cancellationToken)
    {
        ...
        sale.CouponCode = null;
        sale.CouponType = null;
        sale.CouponValue = null;
